...
class MasterProduct extends React.Component {
	static async getInitialProps(ctx) {
		...
		let props = { 
			showHeader: true, showFooter: true, pageName: "/master-product", 
			page: 1, size: 10, sortBy: "name", orderBy: "desc", keyword: "", token: token, fetch_category: "product"
		}
		try {
	...
	constructor(props) {
		...
		this.state = {
            ...
            _listProduct: props.listProduct,
	...
	UNSAFE_componentWillReceiveProps(nextProps) {
		this.setState({
			...
			_listProduct: nextProps.listProduct
		})
	}
	...
	renderModalAddEditItem() {
		...
		return (
			<ModalBox 
				title={isEdited ? `Edit - ${payloadProductName}` : 'New Product Package'} 
				size="lg" 
				className="absolute-center" 
								...
								<Col sm="12" lg="12">
									<Row>
										<Col lg="12">
											<FormInputValidation 
												withLabel={true}
												labelName="Product Package Name"
										...
										<Col lg="12">
											<FormInputValidation 
												withLabel={true}
												labelName="Product Package Price"
												labelClassName="font-14 mb-0 text-999999"
										...
										<Col lg="12">
											<FormInputValidation 
												withLabel={true}
												labelName="Product Package Description"
												labelClassName="font-14 mb-0 text-999999"
												containerClassName="mb-3"
												formClassName="p-2 bg-white mb-0"
										...
										<Col lg="4">
											<ContentBox title="Product Package Photo" className="p-1 overflow-auto" titleClass="font-14 mb-2 text-999999">
											{
												payloadProductImage ? 
				...
				>
					<Row>
						<Col lg="12" className="mb-5">
							<h1 className="text-primary">PRODUCT PACKAGES</h1>
							<span><i className="icon-paperclip mx-1" />Total {_listProduct.total_elements} Product {_listProduct.total_elements > 1 ? 'Packages' : 'Package'}</span>
						</Col>
...
export default connect(state => state, mapDispatchToProps)(MasterProduct)